...
test("Build 76 keeps the Build 75 geometry and refreshes native web caches", () => {
  ...
  assert.match(html, /navigation-phase2-6\.css\?v=2\.0-build79-jpa-dead-ball-internal-v1/);
  assert.match(html, /const PWA_VERSION = "2\.0-build79-jpa-dead-ball-internal-v1"/);
});
