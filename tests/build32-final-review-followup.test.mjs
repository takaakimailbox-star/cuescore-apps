...
test("Player journey visibility synchronizes hidden, aria-hidden, and hit testing",()=>{
  ...
  assert.match(html,/interactiveTargetSelector = "button,a\[href\],input,textarea,select,summary/);
});

test("changed layout assets use a fresh app-shell version",()=>{
  assert.match(html,/navigation-phase2-6\.css\?v=2\.0-build35-match-detail-back-input-v1/);
  assert.match(html,/navigation-phase2-6\.js\?v=2\.0-build35-match-detail-back-input-v1/);
  assert.match(sw,/APP_VERSION = "2\.0-build35-match-detail-back-input-v1"/);
});
