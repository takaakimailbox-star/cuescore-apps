const APP_VERSION = "2.0-build53-original-trends";
const CACHE_NAME = `cuescore-apps-v${APP_VERSION}`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./demo-data.js?v=2.0-build53-original-trends",
  ...
  "./ui-revision-v12.js?v=2.0-build53-original-trends",
  "./final-ui-build18.js",
  "./ui-revision-v12.css?v=2.0-build53-original-trends",
  "./navigation-shell-phase1.css",
  "./navigation-shell-phase1.js",
  "./navigation-phase2-6.css?v=2.0-build53-original-trends",
  "./navigation-phase2-6.js?v=2.0-build53-original-trends",
