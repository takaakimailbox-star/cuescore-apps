const APP_VERSION = "2.0-build26-ui-performance-v1";
const CACHE_NAME = `cuescore-apps-v${APP_VERSION}`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./demo-data.js?v=2.0-build26-ui-performance-v1",
  ...
  "./navigation-phase2-6.css?v=2.0-build26-ui-performance-v1",
  "./navigation-phase2-6.js?v=2.0-build26-ui-performance-v1",
