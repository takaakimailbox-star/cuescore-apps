const APP_VERSION = "2.0-build67-iap-diagnostic-v1";
const CACHE_NAME = `cuescore-apps-v${APP_VERSION}`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./demo-data.js?v=2.0-build67-iap-diagnostic-v1",
  ...
  "./monetization-v1.js?v=1.0-build67-iap-diagnostic-v1",
  "./monetization-v1.css?v=1.0-build67-iap-diagnostic-v1",
