const APP_VERSION = "2.0-build37-match-card-c-visual-reference-v1";
const CACHE_NAME = `cuescore-apps-v${APP_VERSION}`;
const APP_SHELL = [
  "./",
  "./index.html",
  "./demo-data.js?v=2.0-build37-match-card-c-visual-reference-v1",
  ...
  "./ui-revision-v12.js?v=2.0-build37-match-card-c-visual-reference-v2",
  "./final-ui-build18.js",
  "./ui-revision-v12.css?v=2.0-build37-match-card-c-visual-reference-v5",
  "./navigation-shell-phase1.css",
  "./navigation-shell-phase1.js",
  "./navigation-phase2-6.css?v=2.0-build37-match-card-c-visual-reference-v1",
  "./navigation-phase2-6.js?v=2.0-build37-match-card-c-visual-reference-v2",
