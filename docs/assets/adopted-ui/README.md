...
Place only Product Owner-approved UI reference images in this directory.

Each image should have a descriptive, stable filename identifying the screen or
...
- `home-v3.png` — Home logo, six-game vertical list, and three primary menus.
- `match-setup-v3.png` — selected game, two player cards, rules, and start action.
