...
- Approved items: iOS App Version 1.0 and CueScore Pro
- Build: `78`, ID `eb2f6582-c42b-444d-9755-218e5e03ff49`, `VALID`, `APP_STORE_ELIGIBLE`
- Availability: App and CueScore Pro are JPN only; both `availableInNewTerritories=false`
...
- Active phase: Version 1.1 Build 79は`VALID`／`APP_STORE_ELIGIBLE`／internal `IN_BETA_TESTING`。Product Owner physical iPhoneはALL PASS、App Store Updateは未開始
- Build 79 ASC ID: `0b61e6fe-14b6-452a-bc2e-a6b2b02524d2`; App Store Version 1.1／App Review／Release: not started
- Canonical instruction: `docs/handoff/CURRENT_DECISION.md`
- Canonical report: `docs/handoff/CURRENT_REPORT.md`

Detailed evidence: `docs/implementation/CueScore_Build79_Product_Owner_Physical_iPhone_Acceptance_2026-09-26.md`, `docs/implementation/CueScore_Build79_v1.1_JPA_Dead_Ball_Internal_TestFlight_2026-09-26.md`, and `docs/CURRENT_STATE.md`.
