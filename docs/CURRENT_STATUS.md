...
- App Store Connect: Build ID `c0a3dddc-d3f0-4425-a2ab-63ed1b0c249f`、`VALID`、`usesNonExemptEncryption=false`、`CueScore Internal Testers`対象
- Current gate: `READY FOR PRODUCT OWNER BUILD 72 CURRENT PLAN UI TEST`
